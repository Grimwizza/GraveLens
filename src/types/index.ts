...
export interface ResearchData {
  ...
  /** Common alternate spellings / Americanizations of the surname */
  surnameVariants?: string[];
  /** P3 deep-links: WWI draft cards, state vital records, modern obits, fraternal archives */
  researchLinks?: import("@/lib/researchLinks").ResearchLink[];
  /** Pipeline version when this research was last generated. Used for background re-enrichment. */
  researchVersion?: number;
  /** Cached first-person story script generated by /api/story */
  storyScript?: string;
